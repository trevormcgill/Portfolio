...
const Banner = () => {
  return (
    <div id="aboutMe" className="flex banner justify-center items-center flex-col mb-12">
      <div className="container banner-box backdrop-blur-md flex flex-col justify-center items-start w-[40%] h-[60%] rounded-2xl p-12">
        <h1 className="font-bold z-10 mb-8 text-6xl text-slate-50 p-2">
          Trevor McGill
        </h1>
